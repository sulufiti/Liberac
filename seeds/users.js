    ...
    .then(function () {
      return Promise.all([
        knex('users').insert({ 
          id: uuidV4(),
          username: 'samuel1234',
          password_hash: '$2a$10$vvZvK/g2K.yKig.IeDpqI.X3sZtlYViR8/M48faG9n2idZkNgfhgO',
          first_name: 'Samuel',
          last_name: 'Watts',
          contact_number: '(029) 877 5581',
        ...
        knex('users').insert({
          id: uuidV4(),
          username: 'alicia2345',
          password_hash: '$2a$10$cH5TsVe87Eue3zHJ3XKTzu27nRGCfS3f6l1THdjQ3ZF2O7chdjPGq',
          first_name: 'Alicia',
          last_name: 'Ford',
          contact_number: '(026) 294 6300',
        ...
        knex('users').insert({
          id: uuidV4(),
          username: 'alex3456',
          password_hash: '$2a$10$X8q8WjPKOUOBTlbrPhnf0OIg893tz1btob3CjYswD0WkdtJ/3nsP6',
          first_name: 'Alexandra',
          last_name: 'Kent',
          contact_number: '(027) 808 9047',
        ...
        knex('users').insert({
          id: uuidV4(),
          username: '花42',
          password_hash: '$2a$10$Ha5Ozg6R9x7qTZxxyESwgOmRxdzF8ZfaCODmw10Iz7nmhcSVJprk6',
          first_name: '花輪',
          last_name: '正男',
          contact_number: '(026) 456 1546',
